...
@section('content')
        ...
        <div class="container-xl">
          <div class="about-inner ">
            <div class="row">
              ...
              <!--  <figure> <a href="images/fre2.jpg"> <img src="images/fre.jpg" alt="#"> </a> </figure>-->
              <!--</div>-->
            </div>
          </div>
        </div>
	...
	<!--<section class="text-center my-5 new_trem_and"  style="margin: 84px 0 !important;">-->
	<!--	<div class="container-xl">-->
	<!--		<div class="about-inner ">-->
	<!--			<div class="row">-->
	<!--			    <div class=" team3col owl-carousel owl-theme">-->
 <!--                       @foreach($gallery as $item)-->
 <!--                       <div class="item"><figure> <a href="{{asset('public/images/gallery/'.$item->image)}}" data-fancybox="group"><img src="{{asset('public/images/gallery/'.$item->image)}}" alt="#"></a> </figure></div>-->
 <!--                       @endforeach-->
 <!--                   </div>-->
	<!--			</div>	-->
	<!--		</div>-->
 ...
 <!--                   <h2 class=" mb_40 wow fadeInUp" data-wow-delay="0.2s">{{$item->title}}</h2>-->
 <!--                 </div>-->
	<!--			  <p class="wow fadeInUp mb-2" data-wow-delay="0.3s">{!!$item->desc!!}</p>-->
 ...
 <!--     </div>-->
 <!--   </section>-->
 <!--   <section class="text-center my-5 new_trem_and" >-->
	<!--	<div class="container-xl">-->
	<!--		<div class="about-inner ">-->
	<!--			<div class="row">-->
	<!--			    <div class=" team3col owl-carousel owl-theme">-->
