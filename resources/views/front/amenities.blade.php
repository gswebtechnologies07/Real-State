...
@section('content')
  ...
  <div id="smoky">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="about-text">
                  ...
                  <a href="#" class="custom-btn custom-btns light mtb_30 wow fadeInUp" data-wow-delay="0.4s" type="button"><span>View Portfolio</span></a>
                </div>
              </div>
              	<div class="col-lg-6 wow fadeInUp mb-5"  data-wow-delay="0.2s">
    ...
    <!-- =====  WORK WITH US STRAT  ===== -->
    <!-- <section class=" parallax ptb_50" id="Availability" data-source-url="images/fre2.jpg">-->
    <!--  <div class="container-xl">-->
    <!--    <div class="row">-->
